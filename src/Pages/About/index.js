            ...
            <section className="container about">
                <div className="about-left">
                    <div className="about-description">
                        ...
                        <p className='about-text'> Après quelques années, de navigation sur la Seine en tant que capitaine de bateau,
                        ...
                        <p className="about-text">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta tempora iste dicta assumenda dolore maiores reprehenderit nostrum eaque, ipsam, tempore nam quia a, maxime pariatur ratione magni qui suscipit rem.
